...
class QuestionPageTwoh extends StatefulWidget {
  const QuestionPageTwoh({super.key});

  @override
  State<QuestionPageTwoh> createState() => _QuestionPageTwohState();
}

class _QuestionPageTwohState extends State<QuestionPageTwoh> {
    var db = DBconnect();
...
Future<List<Question>> getData() async {
  List<Question> questions = await db.fetchQuestionhardtwo();
