...
class QuestionPageThreeh extends StatefulWidget {
  const QuestionPageThreeh({super.key});

  @override
  State<QuestionPageThreeh> createState() => _MyWidgetState();
}

class _MyWidgetState extends State<QuestionPageThreeh> {
  var db = DBconnect();
